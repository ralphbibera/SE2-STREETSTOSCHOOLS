  ...
  render() {
    return (
      <div className="content-container">
        <div>
          <h1 style={{ fontSize: "5vw" }} className="text-center">
            Donation Platforms
          </h1>
              ...
              <div className="modal-content container-fluid">
                ...
                <div className="modal-body d-lg-flex flex-row">
                  ...
                  <div className="p-lg-2 mx-lg-3">
                    ...
                    <p>
                      Kindly answer the google forms link below after donating
                      for transparency purposes:
                    </p>
                    <a href="https://google.forms.com" target="_blank">
                      https://google.forms.com
                    </a>
                  </div>
                </div>
              </div>
